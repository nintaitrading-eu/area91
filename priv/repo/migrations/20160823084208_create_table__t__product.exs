defmodule Area91.Repo.Migrations.CreateTable_T_PRODUCT do
  ...
  def up do
    ...
    execute "COMMENT ON TABLE T_PRODUCT IS 'Table with products. This is the detailed version of the type of contract or other product_type you deal with. E.g: CCZ3.cfd';"
    execute "COMMENT ON COLUMN T_PRODUCT.product_tick_info_id IS 'May be NULL! The link is only valid for products that are cfd or futures contracts.';"
  end
