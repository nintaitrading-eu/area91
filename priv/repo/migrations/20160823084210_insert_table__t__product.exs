    ...
    execute "
      INSERT INTO T_PRODUCT(name, description, product_type_id, currency_id, market_id, product_tick_info_id, date_created)
           values /*** CFD's ***/
                  ...
                  ('LWBX3.cfd', 'London Wheat (per 0.01), Pound Sterling NovYY', 1, 2, 15, 12, current_date),
                  ...
                  ('ZCZ3.cfd', 'US Corn, US Dollar/100 DecYY', 1, 2, 15, 5, current_date),
                  ...
                  ('LCCH4.cfd', 'London Cocoa Futures, Pound Sterling MarYY', 1, 2, 15, 8, current_date),
                  /* oil */
                  ...
                  ('HGU3.cfd ', 'High Grade Copper (per 0.05), US Dollar SepYY', 1, 2, 15, 7, current_date),
